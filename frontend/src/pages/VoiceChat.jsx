...
//
// Layout:
//   Left  1/3  -- ElevenLabs voice widget + chat transcript + form progress
//   Right 2/3  -- noVNC iframe (live browser) OR idle placeholder
//
// OTP modal and CAPTCHA modal float as overlays ON TOP of the noVNC iframe.
// User can see the live browser behind the modal while they type their answer.
//
// IMPORTANT: No screenshot logic here. The visual is entirely from noVNC.
// This component only manages: show/hide iframe, OTP modal, CAPTCHA modal,
// transcript display, and form progress bar.
